...
export default function StudentHomeMain({navigation}){
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', }}>
      ...
      <Text style={{marginTop:30,width:"90%",backgroundColor:"white",padding:"3%",fontSize:30,fontFamily:"Sofia",borderBottomLeftRadius:30}}>Welcome {name}</Text>
      
      <View style={{marginTop:20,height:"20%",width:"90%",justifyContent:"center",alignItems:"center",elevation:5,backgroundColor:"white",borderBottomLeftRadius:50}}>
      ...
      />
        ...
        onPress={()=>{
          navigation.navigate('gettogethers');
        }}
      ...
      <View style={{marginTop:40,height:"20%",width:"90%",justifyContent:"center",alignItems:"center",elevation:5,backgroundColor:"white",borderBottomLeftRadius:50}}>
      ...
      <TouchableOpacity onPress={() => {
        ...
        style={{marginTop:30,backgroundColor:"red",width:"40%",opacity:0.8,borderRadius:10,}} activeOpacity={0.5}>
